			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Семинар</h2>
						<div class="box-icon">
	...
	<table class="table" border="1">
		...
		<tbody>
			<?php 
				...
				$r = $conn -> query("select * from seminar order by id desc ");
				if (mysqli_num_rows($r)) {
					...
					do {
						...
						<tr>
							...
							<td style="width: 15px;"><a href="./update.php?seminar='.$row["id"].'"><button class="btn btn-warning"> Изменить</a></button></td>
							<td  style="width: 15px;"><a href="./delete.php?seminar='.$row["id"].'"><button class="btn btn-danger">Удалить</button></a></td>
					  	</tr>
						';
